...
// 1. Coleta os dados do usuário (Boa sacada usar o teclado.nextLine() depois do nextInt!)
...
boolean loginSucesso = VdaoLogin.autenticar(Vlogin.getNome_login(), Vlogin.getSenha_login());
